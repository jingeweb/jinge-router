import {
  Component, setAttribute, ComponentAttributes, MessengerListener,
  removeEvent, addEvent, __, isObject, watch, unwatch
} from 'jinge';
import {
  RouteJumpTarget, RouteLocation, isParamsOrQuerySameOrInclude
} from '../common';
import {
  Router
} from '../router';
